...
public enum NF3eNotaInfoImpostoTributacaoCOFINS {
    ...
    NF3eNotaInfoImpostoTributacaoCOFINS(final String codigo, final String descricao) {
        this.codigo = codigo;
    ...
    public static NF3eNotaInfoImpostoTributacaoCOFINS valueOfCodigo(final String codigo) {
        for (final NF3eNotaInfoImpostoTributacaoCOFINS valor : NF3eNotaInfoImpostoTributacaoCOFINS.values()) {
